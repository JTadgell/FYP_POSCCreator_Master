...
{
    uint8 staticBits = (Laser_DR & (uint8)(~Laser_MASK));
    Laser_DR = staticBits | ((uint8)(value << Laser_SHIFT) & Laser_MASK);
}
...
{
	CyPins_SetPinDriveMode(Laser_0, mode);
}
...
{
    return (Laser_PS & Laser_MASK) >> Laser_SHIFT;
}
...
{
    return (Laser_DR & Laser_MASK) >> Laser_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Laser_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Laser_0_INTR) != 0u) 
		{ 
			 Laser_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Laser_INTSTAT & Laser_MASK) >> Laser_SHIFT;
    }
