...
-- === RGB LED ===
attribute port_location of RED(0) : label is "PORT(5,2)"; -- RED LED
attribute port_location of GREEN(0) : label is "PORT(5,3)"; -- GREEN LED
attribute port_location of BLUE(0) : label is "PORT(5,4)"; -- BLUE LED
