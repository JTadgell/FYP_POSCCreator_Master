...
-- === RGB LED ===
attribute port_location of RED(0) : label is "PORT(0,6)"; -- RED LED
attribute port_location of GREEN(0) : label is "PORT(2,6)"; -- GREEN LED
attribute port_location of BLUE(0) : label is "PORT(6,5)"; -- BLUE LED
